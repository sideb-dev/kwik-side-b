...
GMLFN(draw_text_transformed_color); GMLFN(draw_text_transformed_colour);
...
GMLFN(animcurve_get);
GMLFN(animcurve_get_channel);
GMLFN(animcurve_get_channel_index);
GMLFN(array_set);
GMLFN(array_sort);
GMLFN(audio_channel_num);
GMLFN(audio_emitter_create);
GMLFN(audio_emitter_exists);
GMLFN(audio_emitter_falloff);
GMLFN(audio_emitter_free);
GMLFN(audio_emitter_gain);
GMLFN(audio_emitter_pitch);
GMLFN(audio_emitter_position);
GMLFN(audio_emitter_velocity);
GMLFN(audio_exists);
GMLFN(audio_falloff_set_model);
GMLFN(audio_get_name);
GMLFN(audio_listener_orientation);
GMLFN(audio_listener_position);
GMLFN(audio_listener_velocity);
...
GMLFN(colour_get_blue);
GMLFN(colour_get_green);
GMLFN(colour_get_hue);
GMLFN(colour_get_red);
GMLFN(colour_get_saturation);
GMLFN(colour_get_value);
GMLFN(date_get_day);
GMLFN(date_get_hour);
...
GMLFN(draw_flush);
GMLFN(draw_get_colour);
GMLFN(draw_set_lighting);
...
GMLFN(gif_open);
GMLFN(gif_save);
GMLFN(gif_save_buffer);
GMLFN(gpu_get_alphatestenable);
GMLFN(gpu_get_blendenable);
GMLFN(gpu_get_blendmode);
GMLFN(gpu_get_blendmode_dest);
GMLFN(gpu_get_blendmode_ext);
GMLFN(gpu_get_blendmode_src);
GMLFN(gpu_get_colorwriteenable);
GMLFN(gpu_get_colourwriteenable);
GMLFN(gpu_get_cullmode);
GMLFN(gpu_get_tex_filter);
GMLFN(gpu_get_texrepeat);
GMLFN(gpu_get_ztestenable);
GMLFN(gpu_get_zwriteenable);
GMLFN(gpu_set_blendmode_ext_sepalpha);
GMLFN(gpu_set_colourwriteenable);
...
GMLFN(layer_background_destroy);
GMLFN(layer_background_index);
GMLFN(layer_background_speed);
GMLFN(layer_element_move);
GMLFN(layer_instance_get_instance);
GMLFN(layer_shader);
GMLFN(layer_sprite_alpha);
GMLFN(layer_sprite_angle);
GMLFN(layer_sprite_blend);
GMLFN(layer_sprite_create);
GMLFN(layer_sprite_exists);
GMLFN(layer_sprite_index);
GMLFN(layer_sprite_xscale);
GMLFN(layer_sprite_yscale);
GMLFN(matrix_build);
...
GMLFN(part_emitter_burst);
GMLFN(part_emitter_create);
GMLFN(part_emitter_destroy);
GMLFN(part_emitter_destroy_all);
GMLFN(part_emitter_region);
GMLFN(part_emitter_stream);
GMLFN(part_particles_clear);
GMLFN(part_particles_count);
GMLFN(part_particles_create);
GMLFN(part_particles_create_color);
GMLFN(part_particles_create_colour);
GMLFN(part_system_automatic_draw);
GMLFN(part_system_automatic_update);
GMLFN(part_system_clear);
GMLFN(part_system_create);
GMLFN(part_system_create_layer);
GMLFN(part_system_depth);
GMLFN(part_system_destroy);
GMLFN(part_system_drawit);
GMLFN(part_system_exists);
GMLFN(part_system_position);
GMLFN(part_system_update);
GMLFN(part_type_alpha1);
GMLFN(part_type_alpha2);
GMLFN(part_type_alpha3);
GMLFN(part_type_blend);
GMLFN(part_type_clear);
GMLFN(part_type_color1);
GMLFN(part_type_color2);
GMLFN(part_type_color3);
GMLFN(part_type_colour1);
GMLFN(part_type_colour2);
GMLFN(part_type_colour3);
GMLFN(part_type_create);
GMLFN(part_type_destroy);
GMLFN(part_type_direction);
GMLFN(part_type_exists);
GMLFN(part_type_gravity);
GMLFN(part_type_life);
GMLFN(part_type_orientation);
GMLFN(part_type_scale);
GMLFN(part_type_shape);
GMLFN(part_type_size);
GMLFN(part_type_speed);
...
GMLFN(shader_replace_simple_init_raw);
GMLFN(shader_replace_simple_raw);
GMLFN(shader_replace_simple_sync);
GMLFN(shader_set_uniform_f_array);
GMLFN(shader_set_uniform_i);
GMLFN(shader_set_uniform_matrix);
GMLFN(shader_set_uniform_matrix_array);
GMLFN(sprite_collision_mask);
GMLFN(sprite_get_info);
GMLFN(sprite_get_speed);
GMLFN(sprite_get_speed_type);
GMLFN(sprite_set_bbox_mode);
...
GMLFN(surface_depth_disable);
GMLFN(surface_get_depth_disable);
GMLFN(surface_resize);
GMLFN(surface_save);
GMLFN(surface_save_part);
GMLFN(texture_get_height);
GMLFN(texture_get_uvs);
GMLFN(texture_get_width);
GMLFN(tile_get_flip);
...
GMLFN(vertex_color);
GMLFN(vertex_colour);
GMLFN(vertex_create_buffer_ext);
GMLFN(vertex_delete_buffer);
GMLFN(vertex_end);
GMLFN(vertex_format_add_position);
GMLFN(vertex_freeze);
GMLFN(vertex_normal);
GMLFN(vertex_position);
GMLFN(vertex_position_3d);
GMLFN(vertex_submit);
GMLFN(vertex_texcoord);
GMLFN(video_close);
GMLFN(video_draw);
GMLFN(video_enable_loop);
GMLFN(video_get_duration);
GMLFN(video_get_format);
GMLFN(video_get_position);
GMLFN(video_get_status);
GMLFN(video_is_looping);
GMLFN(video_open);
GMLFN(video_pause);
GMLFN(video_resume);
GMLFN(video_seek_to);
